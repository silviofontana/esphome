...
LM75Sensor = lm75_ns.class_(
    "LM75Sensor", cg.PollingComponent, sensor.Sensor, i2c.I2CDevice
)

EConversionRate = lm75_ns.enum("EConversionRate")
CONVERSION_RATES = {
...
EAlertFunction = lm75_ns.enum("EAlertFunction")
ALERT_FUNCTION = {
